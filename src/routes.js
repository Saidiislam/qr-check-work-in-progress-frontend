...
const routes = [
  ...
  { path: '/theme/table', name: 'Table', component: Table },
  { path: '/theme/filterUserTable', name: 'FilterUserTabele', component: filterUserTable },
  { path: '/theme/qrcodeUser', name: 'QrCodeUserData', component: QrCodeUserData },
